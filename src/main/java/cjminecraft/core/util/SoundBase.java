...
public class SoundBase extends PositionedSound {
	...
	public SoundBase(SoundEvent sound, SoundCategory category, float volume, float pitch, boolean repeat,
			int repeatDelay) {

		this(sound.getSoundName(), category, volume, pitch, repeat, repeatDelay, 0, 0, 0, AttenuationType.NONE);
	}

	public SoundBase(SoundEvent sound, SoundCategory category, float volume, float pitch, double x, double y,
			double z) {
	...
	public SoundBase(ResourceLocation sound, SoundCategory category, float volume, float pitch, boolean repeat,
			int repeatDelay) {

		this(sound, category, volume, pitch, repeat, repeatDelay, 0, 0, 0, AttenuationType.NONE);
	}

	public SoundBase(ResourceLocation sound, SoundCategory category, float volume, float pitch, double x, double y,
			double z) {
	...
	public SoundBase(SoundBase other) {
		...
		this(other.getSoundLocation(), other.category, other.volume, other.pitch, other.repeat, other.repeatDelay,
				other.xPosF, other.yPosF, other.zPosF, other.attenuationType);
	}
}
